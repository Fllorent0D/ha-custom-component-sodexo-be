...
# Pluxee Belgium - Home Assistant Integration
...
- **Lunch Pass** - Your lunch pass balance
- **Eco Pass** - Your eco pass balance
- **Gift Pass** - Your gift pass balance
- **Conso Pass** - Your conso pass balance
...
type: entities
entities:
  - entity: sensor.pluxee_USERNAME_lunch_pass
    secondary_info: last-updated
    tap_action:
      action: call-service
      service: homeassistant.update_entity
      target:
        entity_id: sensor.pluxee_USERNAME_lunch_pass
```
